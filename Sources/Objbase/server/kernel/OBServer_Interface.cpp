...
{
	DEBUG_STACK_NAME (GET_ERROR_DESCRIPTION);
	static string STATIC_ERR;
	STATIC_ERR = "";
	for (int e=0; e<theOBServer_ERROR_DESCRIPTION_ARR.Size(); e++)
	{
		if (theOBServer_ERROR_DESCRIPTION_ARR[e].nEnum==nErr)
		{
			STATIC_ERR = theOBServer_ERROR_DESCRIPTION_ARR[e].sDesc;
		}
	}
	return STATIC_ERR.c_str();
}
//____________________________________________________________________________[]

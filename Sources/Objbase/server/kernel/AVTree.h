...
#define USAGE_CONSTRUCTOR_ARGS //!!! -- выключить если появятся ошибки
...
class IT_AVTree
{
	struct IT_AVTreeNode
	{
		...
		ITEM_TYPE			Item;
		BYTE					Depth;
#ifdef USAGE_CONSTRUCTOR_ARGS
		IT_AVTreeNode (ITEM_TYPE& a_Item) : Item (a_Item) {}
#endif
	};  
	IT_AVTreeNode *		Root;
	int						count;
